...
export const metadata: Metadata = {
    title: "QuickAccounting | Free Invoice Generator",
    description:
        "Create invoices effortlessly with  QuickAccouting, the free invoice generator. Try it now!",
    ...
    return (
        <html lang={locale}>
            <head>
                ...
                />
                <script data-name="BMC-Widget" data-cfasync="false" src="https://cdnjs.buymeacoffee.com/1.0.0/widget.prod.min.js" data-id="aliabb" data-description="Support me on Buy me a coffee!" data-message="Thank you for using QuickAccounting" data-color="#5F7FFF" data-position="Right" data-x_margin="18" data-y_margin="18"></script>
            </head>
            <body
